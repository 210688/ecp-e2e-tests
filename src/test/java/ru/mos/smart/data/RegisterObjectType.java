...
public class RegisterObjectType {
    ...
    public static final String OBJECT_OPERATION = "Разрешения на ввод объекта в эксплуатацию";
    public static final String BUILDING_PERMIT_REGISTER = "Разрешения на строительство";
    ...
    public static final String CRD = "СД";
